...
public class PurchaseAnalysis {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // debug
        //userInfoKStream.foreach((String localGender, OrderUserItem orderUserItem) -> System.out.printf("localGender = %s, age = %s, orderItemName = %s, quantity = %s, price = %s  \n", localGender, orderUserItem.getAge(), orderUserItem.getItemName(), orderUserItem.getQuantity(), orderUserItem.getItemPrice()));
        //userInfoKStream.foreach((String localGender, OrderInfoCount orderInfoCount) -> System.out.printf("localGender = %s, itemCount = %s, orderCount = %s, salesCount = %s  \n", localGender, orderInfoCount.getItemCount(), orderInfoCount.getOrderCount(), orderInfoCount.getTotalSales().doubleValue() ));
        ...
        orderCount
                .toStream()
                .map( (String localGender, OrderInfoCount orderInfoCount) -> new KeyValue(localGender, orderInfoCount.getItemCount() + "," + orderInfoCount.getOrderCount() + "," + orderInfoCount.getTotalSales().doubleValue() ) )
                .to("gender-amount");

        // debug
        orderCount
                .toStream()
                .map( (String localGender, OrderInfoCount orderInfoCount) -> new KeyValue<String, String>(localGender, orderInfoCount.getItemCount() + "," + orderInfoCount.getOrderCount() + "," + orderInfoCount.getTotalSales().doubleValue() ) )
                .foreach( (String key, String value) -> System.out.printf("key = %s, value = %s\n", key, value) );
